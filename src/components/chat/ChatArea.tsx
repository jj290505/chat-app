...
import { Phone, Video, Info, Loader2, Trash2 } from "lucide-react"
...
export default function ChatArea() {
    const [messages, setMessages] = useState<Message[]>([
        { id: "welcome-ai", sender: "Nexus AI", role: "assistant", content: "Hello! I am Nexus AI. I can assist you with your conversation or provide information directly. Just ask me anything!", time: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }) },
    ])
            ...
            <div className="h-16 border-b flex items-center justify-between px-6 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-10 flex-shrink-0">
                <div className="flex items-center gap-3">
                    <Avatar className="h-9 w-9 bg-primary/20">
                        <AvatarFallback className="text-primary font-bold">AI</AvatarFallback>
                    </Avatar>
                    <div>
                        <p className="text-sm font-semibold">Nexus AI</p>
                        <p className="text-[10px] text-green-500 font-medium">Assistant</p>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    {/* Delete Conversation Button - Only show when conversation exists */}
